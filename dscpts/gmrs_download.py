...
urls = [
    ...
    "ftp://wirelessftp.fcc.gov/pub/uls/complete/l_gmrs.zip"
]

script_dir = os.path.dirname(os.path.abspath(__file__))
zip_path = os.path.join(script_dir, "gmrs.zip")
json_path = os.path.join(script_dir, "gmrs_clean.json")
...
# ---------------------------
# Process GMRS dataset with FRN fix
# ---------------------------
calls = {}
...
print(f"Processed {len(calls)} unique GMRS callsigns saved to {json_path}")
