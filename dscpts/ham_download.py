...
json_path = os.path.join(script_dir, "amateur_clean.json")
...
# ---------------------------
# Extract only EN.dat and delete other files
# ---------------------------
...
print(f"Processed {len(calls)} unique callsigns saved to {json_path}")
